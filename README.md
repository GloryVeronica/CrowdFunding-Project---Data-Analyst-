...
- Build **interactive dashboards** that visualize KPIs and trends clearly.  
- Help campaign creators and platforms make **data-driven decisions**.
...
4. Standardized all goal amounts into **USD** using fixed exchange rates.  
5. Analyzed total projects by **outcome, location, and category**.  
6. Assessed project creation trends by **year, quarter, and month**.  
7. Measured successful projects’ total funds raised, backers, and duration.  
8. Identified **top projects** by backers and amount raised.  
9. Calculated **success rates** by category, time, and goal range.  
10. Revealed seasonal and quarterly patterns in project success.
...
| **Power BI** | Interactive dashboards, KPI cards, and visual analytics |
| **Tableau** | Advanced trend visualization, storytelling & insights generation |
| **SQL** | Querying, Data extraction, transformation, and aggregation |
...
- **Early engagement** and shorter durations improved success chances.  
- Recommended focusing on **high-success categories and optimal goal ranges**.
...
Amount Raised: **$3,479M**

Total Backers: **140.3K**

Avg. Duration (Successful): **80.43 days**
...
Failed Projects: **188.2K** (~51.4%) didn’t meet their targets, forming the majority.
...
Best Quarter: Q3 (July–Sept) showed the strongest performance.
...
Tabletop Games **(15.6K)** and Music **(15.1K)** follow with strong engagement.
...
Great Britain: **0.03M** projects, ranking second.
...
$5K–$20K: Moderate success **(35.9%)**.

>$100K: Lowest success **(6.4%)** — harder to achieve.
